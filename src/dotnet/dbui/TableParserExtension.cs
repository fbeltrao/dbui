...
{
    /// <summary>
    /// Copied from: https://github.com/Robert-McGinley/TableParser/blob/master/TableParser/TableParserExtensions.cs
    /// </summary>
    public static class TableParserExtensions
    {
        ...
        public static string ToStringTable(this DataTable table)
        {
            ...
            var arrValues = new string[table.Rows.Count + 1, table.Columns.Count];
            ...
            for (int rowIndex = 1; rowIndex <= arrValues.GetLength(0); rowIndex++)
            {
                for (int colIndex = 0; colIndex < arrValues.GetLength(1); colIndex++)
                {
                    ...
                    if (cellValue != null && !Convert.IsDBNull(cellValue))
                        cellValueAsString = cellValue.ToString();

                    arrValues[rowIndex, colIndex] = cellValueAsString;
                }
            }
